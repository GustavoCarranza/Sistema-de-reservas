...
include('../../../Modelos/Base/base_datos.php');//Conexion a la base de datos 
    $salida = "";
    $buscar_reservaciones = "SELECT * FROM reservas_restaurante r INNER JOIN restaurantes nr ON r.nombre_restaurante = nr.id_restaurante  ORDER BY nombre_restaurante,fecha_reserva,horario_reserva" ; //Consulta para solicitar todos los datos de la tabla
    ...
    if($resultado->num_rows > 0){
        ...
        while($arreglo = $resultado->fetch_assoc()){//creamos un arregalo y o asociamos con la variable que tiene alojada la consulta 
            $salida.="<tr>
                    ...
                    <a href='../../../Controladores/Restaurantes/Administrador/eliminar_reservaciones.php?id_reserva=". $arreglo['id_reserva_R']."' class='btn_eliminar eliminar_reservacion'><i class='bx bx-trash'></i></a>
                    ...
                    include('../../../Vistas/Views/Views_modals/Administrador/Modal_restaurantes.php');//Modal para editar informacion del practicante 
                }
            $salida.="</tbody></table>";
...
<script src="../../../Vistas/js/Editar_infor_restaurante.js"></script>
