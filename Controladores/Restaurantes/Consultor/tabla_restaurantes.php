...
include('../../../Modelos/Base/base_datos.php');//Conexion a la base de datos 
    $salida = "";
    $buscar_reservaciones = "SELECT * FROM reservas_restaurante r INNER JOIN restaurantes nr ON r.nombre_restaurante = nr.id_restaurante ORDER BY nombre_restaurante,horario_reserva,fecha_reserva" ; //Consulta para solicitar todos los datos de la tabla
