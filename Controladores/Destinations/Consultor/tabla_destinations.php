...
include('../../../Modelos/Base/base_datos.php');//Conexion a la base de datos 
    $salida = "";
    $buscar_reservaciones = "SELECT * FROM reservas_destinations r INNER JOIN destinations nr ON r.name_destination = nr.id_destinations ORDER BY fecha_reserva,horario_reserva,nombre_destination" ; //Consulta para solicitar todos los datos de la tabla
