...
$nombre_destination = $_POST['nombre_destination_siguiente'];
...
$sql = $conexion->query("INSERT INTO reservas_destinations (name_destination,huesped,apellidos,villa,propiedad,numero_personas,kids,fecha_reserva,horario_reserva,comentarios,solicitante,usuario) VALUES ('$nombre_destination','$huesped','$apellidos','$villa','$propiedad','$no_personas','$no_kids','$fecha','$horario','$comentarios','$solicitante','$usuario')");
