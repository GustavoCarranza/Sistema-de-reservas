    ...
    if($resultado->num_rows > 0){
        ...
        while($arreglo = $resultado->fetch_assoc()){//creamos un arregalo y o asociamos con la variable que tiene alojada la consulta 
            $salida.="<tr>
                    ...
                    <a href='../../../../Controladores/Eventos/Reservaciones/reservas_futuras/eliminar_reservacion.php?id_reserva=". $arreglo['id_reserva_E']."' class='btn_eliminar eliminar_reservacion'><i class='bx bx-trash'></i></a>
