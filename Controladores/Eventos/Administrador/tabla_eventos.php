    ...
    if($resultado->num_rows > 0){
        ...
        while($arreglo = $resultado->fetch_assoc()){//creamos un arregalo y o asociamos con la variable que tiene alojada la consulta 
            $salida.="<tr>
                    ...
                    <a href='../../../Controladores/Eventos/Administrador/eliminar_reservaciones.php?id_reserva=". $arreglo['id_reserva_E']."' class='btn_eliminar eliminar_reservacion'><i class='bx bx-trash'></i></a>
                    ...
                    include('../../../Vistas/Views/Views_modals/Administrador/Modal_eventos.php');//Modal para editar informacion del practicante 
                }
            $salida.="</tbody></table>";
...
<script src="../../../Vistas/js/Editar_info_eventos.js"></script>