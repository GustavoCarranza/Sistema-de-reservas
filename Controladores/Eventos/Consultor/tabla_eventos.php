...
include('../../../Modelos/Base/base_datos.php');//Conexion a la base de datos 
    $salida = "";
    $buscar_reservaciones = "SELECT * FROM reservas_eventos E INNER JOIN eventos EV ON E.name_evento = EV.id_evento ORDER BY fecha_reserva,horario_reserva,name_evento" ; //Consulta para solicitar todos los datos de la tabla
