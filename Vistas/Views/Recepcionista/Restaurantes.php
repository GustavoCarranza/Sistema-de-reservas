...
<!--Sidebar-->
    <nav class="nav containeer">
            <div class="nav_logo">
                <a href="Bienvenida_recepcionista.php"><h3 class="nav_titulo"><i class="bx bx-wine"></i> Reservaciones en restaurantes</h3></a>
            </div>
        ...
        <tbody>
            ...
            foreach($consulta as $reservas){
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../../Controladores/Restaurantes/Recepcion/eliminar_reservaciones.php?id_reserva=<?php echo $reservas['id_reserva_R']; ?>" class="btn_eliminar eliminar_reservacion"><i class="bx bx-trash"></i></a>
...
<script src="../../js/Recepcion/Editar_info_restaurante.js"></script>
<!--datatable-->
...
<script src="../../js/Recepcion/Agregar_buscar_reservas_R.js"></script>
</body>
</html>