...
<!--Sidebar-->
    <nav class="nav containeer">
            <div class="nav_logo">
            <a href="Bienvenida_recepcionista.php"><h3 class="nav_titulo"><i class="bx bx-wine"></i> Reservaciones en Destinations</h3></a>
            </div>

            <ul class="nav_link nav_link--menu">
                <li class="nav_opciones">
                <button type="submit" class="nav_links" data-bs-toggle="modal" data-bs-target="#destinations"><i    class="bx bx-plus"></i> Agregar </button>
                </li>
				<li class="nav_opciones">
                    <button type="submit" class="nav_links" data-bs-toggle="modal" data-bs-target="#reservas"><i class="bx bx-table"></i> Reservas </button>
                </li>
                <li class="nav_opciones">
...
<!--Ventanas modales -->
    <?php include("../Views_modals/Recepcion/Modal_destinations.php");?> 
<!--Fin de ventanas-->
...
<!--Contenido de tabla-->
    <section class="contenido_tabla">
        ...
        <thead>
            <tr>
                ...
                <th class="text-center" style="background: #373737; color:#fff;">Fecha de edición</th>
        ...
        <tbody>
            ...
            foreach($consulta as $reservas){
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../../Controladores/Destinations/Recepcion/eliminar_reservaciones.php?id_reserva=<?php echo $reservas['id_reserva_D']; ?>" class="btn_eliminar eliminar_desti"><i class="bx bx-trash"></i></a>
    ...
    <?php include('../Views_modals/Recepcion/Modal_editar_destinations.php'); ?>
            </div>
    </section>
<!--Fin-->

<!--Editar reservaciones de destinations-->
<script src="../../js/Recepcion/Editar_info_destination.js"></script>
<!--datatable-->
...
<!--Js de tabla-->
<script src="../../js/Recepcion/Agregar_buscar_reservas_D.js"></script>
