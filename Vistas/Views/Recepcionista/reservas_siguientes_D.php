...
<!--Contenido de tabla-->
    ...
    <table id="tablas_generales" class="table table-striped nowrap" style="width:100%">
        ...
        <tbody>
            ...
            $consulta = $conexion->query("SELECT * FROM reservas_destinations RD INNER JOIN destinations d ON RD.name_destination = d.id_destinations WHERE fecha_reserva > CURDATE() AND fecha_creacion != CURDATE()");
            foreach($consulta as $reservas){
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../../Controladores/Destinations/Recepcion/Consultar/Reservas_siguientes/eliminar.php?id_reserva=<?php echo $reservas['id_reserva_D']; ?>" class="btn_eliminar eliminar_reservacion_siguiente"><i class="bx bx-trash"></i></a>
...
<script src="../../js/reservas_siguientes/Recepcion/editar_eliminar_reserva_D.js"></script>
...
<!-- JS -->
<script src="../../js/reservas_siguientes/Recepcion/agregar_reserva_D.js"></script>
