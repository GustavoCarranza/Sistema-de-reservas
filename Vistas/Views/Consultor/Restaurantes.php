...
<!--Sidebar-->
    <nav class="nav containeer">
            <div class="nav_logo">
                <a href="Bienvenida_consultor.php"><h3 class="nav_titulo"><i class="bx bx-wine"></i> Reservaciones en restaurantes</h3></a>
            </div>
...
<!--Ventanas modales -->
    <?php include("../Views_modals/Consultor/Modal_restaurantes.php");?> 
<!--Fin de ventanas-->
