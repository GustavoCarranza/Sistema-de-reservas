...
<!--Sidebar-->
    <nav class="nav containeer">
            <div class="nav_logo">
            <a href="Bienvenida_administrador.php"><h3 class="nav_titulo"><i class="bx bx-wine"></i> Reservaciones en Destinations</h3></a>
            </div>
        ...
        <tbody>
            ...
            foreach($consulta as $reservas){
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../../Controladores/Destinations/Administrador/eliminar_reservaciones.php?id_reserva=<?php echo $reservas['id_reserva_D']; ?>" class="btn_eliminar eliminar_desti"><i class="bx bx-trash"></i></a>
...
<script src="../../js/Editar_info_destination.js"></script>
<!--datatable-->
