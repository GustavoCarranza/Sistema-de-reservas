...
<!--Sidebar-->
    <nav class="nav containeer">
            <div class="nav_logo">
            <a href="Bienvenida_administrador.php"><h3 class="nav_titulo"><i class="bx bx-wine"></i> Reservaciones en Eventos</h3></a>
            </div>
...
<!--Ventanas modales -->
    <?php include("../Views_modals/Administrador/Modal_eventos.php");?> 
<!--Fin de ventanas-->
...
<!--Contenido de tabla-->
    <section class="contenido_tabla">
        ...
        <thead>
            <tr>
                ...
                <th class="text-center" style="background: #373737; color:#fff;">Evento</th>
        ...
        <tbody>
            ...
            foreach($consulta as $reservas){
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../../Controladores/Eventos/Administrador/eliminar_reservaciones.php?id_reserva=<?php echo $reservas['id_reserva_E']; ?>" class="btn_eliminar eliminar_reservacion"><i class="bx bx-trash"></i></a>
    ...
    <?php include('../Views_modals/Administrador/Modal_editar_eventos.php'); ?>
			</div>
    </section>
<!--Fin-->


<!--Script para editar informacion de los eventos-->
<script src="../../js/Editar_info_eventos.js"></script>
<!--datatable-->
