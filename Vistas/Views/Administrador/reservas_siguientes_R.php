        ...
        <tbody>
            ...
            foreach($consulta as $reservas){
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../../Controladores/Restaurantes/Administrador/Consultar/Reservas_siguientes/eliminar.php?id_reserva=<?php echo $reservas['id_reserva_R']; ?>" class="btn_eliminar eliminar_reservacion_siguiente"><i class="bx bx-trash"></i></a>
...
<script src="../../js/reservas_siguientes/editar_eliminar_reserva.js"></script>
...
<!-- JS -->
<script src="../../js/reservas_siguientes/agregar_reservas.js"></script>
