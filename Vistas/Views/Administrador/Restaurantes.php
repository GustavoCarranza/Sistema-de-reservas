...
<!--Contenido de tabla-->
    ...
    <table id="tablas_generales" class="table table-striped nowrap" style="width:100%">
        ...
        <tbody>
            ...
            $consulta = $conexion->query("SELECT * FROM reservas_restaurante RE INNER JOIN restaurantes R ON RE.nombre_restaurante = r.id_restaurante WHERE fecha_reserva = CURDATE()  ORDER BY horario_reserva");
            foreach($consulta as $reservas){
                ...
                <tr>
                    ...
                    <td>
                        <a href="../../../Controladores/Restaurantes/Administrador/eliminar_reservaciones.php?id_reserva=<?php echo $reservas['id_reserva_R']; ?>" class="btn_eliminar eliminar_reservacion"><i class="bx bx-trash"></i></a>

                        <button type="submit" class="btn_editar editar_resta" data-bs-toggle='modal' data-bs-target='#editar_reserva'><i class="bx bx-edit"></i></button>
                    </td>
    ...
    <?php include('../Views_modals/Administrador/modal_editar_restaurantes.php'); ?>
			</div>
    </section>
<!--Fin-->

<script src="../../js/Editar_infor_restaurante.js"></script>
