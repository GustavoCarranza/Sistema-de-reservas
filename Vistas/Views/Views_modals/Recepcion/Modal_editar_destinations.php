    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="formulario">
              <form action="../../../Controladores/Destinations/Recepcion/editar_reservas.php" method="post" id="editar_info_destination">
...
<div class="modal fade" id="editar_reserva_siguientes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="formulario">
              <form action="../../../Controladores/Destinations/Recepcion/Consultar/Reservas_siguientes/editar.php" method="post" id="editar_info_destination_siguiente">
                  <div class="contenido_inputs">
