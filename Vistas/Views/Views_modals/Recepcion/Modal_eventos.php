    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="formulario">
              <form action="../../../Controladores/Eventos/Recepcion/agregar_reservacion.php" method="post" id="form_reservas_E">
...
<div class="modal fade" id="editar_reserva" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="formulario">
              <form action="../../../Controladores/Destinations/Recepcion/editar_reservacion.php" method="post" id="editar_info_evento">
                  <div class="contenido_inputs">
