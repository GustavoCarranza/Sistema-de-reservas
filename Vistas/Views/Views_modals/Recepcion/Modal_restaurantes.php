    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="formulario">
              <form action="../../../Controladores/Restaurantes/Recepcion/agregar_reservacion.php" method="post" id="form_reservas_R">
...
<div class="modal fade" id="restaurantes_siguientes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="formulario">
              <form action="../../../Controladores/Restaurantes/Recepcion/Consultar/Reservas_siguientes/agregar.php" method="post" id="form_reservas_S">
                  <div class="contenido_inputs">
