            ...
            <div class="formulario">
              <form action="../../../Controladores/Restaurantes/Administrador/editar_reservacion.php" method="post" id="editar_info_restaurante">
                  <div class="contenido_inputs">
                    ...
                    <input type="hidden" class="input" name="idreserva" id="id_reserva">
...
<div class="modal fade" id="editar_reserva_siguientes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="formulario">
              <form action="../../../Controladores/Restaurantes/Administrador/Consultar/Reservas_siguientes/editar.php" method="post" id="editar_siguientes">
                  <div class="contenido_inputs">
