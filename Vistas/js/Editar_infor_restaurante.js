//Funcion para editar reservaciones en restaurantes
(function(){
    $('.editar_restaurantes').on('click',function(){
        ...
        $('#editar_telefono').val(datos_restaurante[12]);
    });
    ...
    document.getElementById('editar_info_restaurante').addEventListener('submit', function(e){//mandamos a llamar al formulario por ID y le añadimos un evento de tipo submit
        ...
        let editar_reserva_R = new FormData(document.getElementById('editar_info_restaurante'));
             fetch('../../../Controladores/Restaurantes/Administrador/editar_reservacion.php',{//redireccionamos a nuestro archivo php para la consulta de agregar los datos a la BD 
                  method: 'POST',
             ...
             .then(datos_restaurante =>{
                if(datos_restaurante == 1){
                  ...
                  .then(function(){
                       window.location = "../../../Vistas/Views/Administrador/Restaurantes.php";
                })
             }
         });
        })
