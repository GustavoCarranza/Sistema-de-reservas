...
(function(){
    ...
    document.getElementById('editar_info_evento').addEventListener('submit', function(e){//mandamos a llamar al formulario por ID y le añadimos un evento de tipo submit
        ...
        let editar_reserva_E = new FormData(document.getElementById('editar_info_evento'));
             fetch('../../../Controladores/Eventos/Recepcion/editar_reservacion.php',{//redireccionamos a nuestro archivo php para la consulta de agregar los datos a la BD 
                  method: 'POST',
             ...
             .then(datos_evento =>{
                if(datos_evento == 1){
                  ...
                  .then(function(){
                       window.location = "../../../Vistas/Views/Recepcionista/Eventos.php";
                })
             }
         });
        })
