...
(function(){
    document.getElementById('form_reservas_D_siguiente').addEventListener('submit', function(e){
         e.preventDefault();
         let form_reservas_R = new FormData(document.getElementById('form_reservas_D_siguiente'));
              fetch('../../../Controladores/Destinations/Administrador/Consultar/Reservas_siguientes/agregar.php',{
                   method: 'POST',
